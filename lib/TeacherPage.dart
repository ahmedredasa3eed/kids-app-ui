...
class _TeacherPageState extends State<TeacherPage> {
  ...
  Widget build(BuildContext context) {
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Mr. Ahmed Reda", style: TextStyle(
                        fontSize: 21,
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("About Mr Ahmed Reda", style: TextStyle(
                      fontWeight: FontWeight.w700,
                      fontSize: 17,
                      fontFamily: 'product'
                    ),),
                    SizedBox(height: 10,),
                    Text("I have been a teacher as well as a director in the child care setting since the early 2019’s. I love working with children and watching them grow. My is children learn through play with teacher guidance and children choices.", style: TextStyle(
                      fontFamily: 'circe',
                      fontSize: 15,
                    ),),
                    SizedBox(height: 30,),
                    Text("Courses Made by Ahmed", style: TextStyle(
                        fontWeight: FontWeight.w700,
                        fontSize: 17,
                        fontFamily: 'product'
                    ),),
   ...
   Widget timeSlotWidget(String time, bool isSelected)
  {
    return Container(
  ...
  InkWell dateWidget(int i)
  {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.all(Radius.circular(10)),
          color: (selectedDate == currentDate.day) ? yellow : lightBlue.withOpacity(0.5),
        ),
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(dayValue(currentDate.weekday), style: TextStyle(
                fontSize: 10
              ),),
              Text(currentDate.day.toString(), style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w500
              ),)
            ],
